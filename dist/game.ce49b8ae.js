...
},{}],"node_modules/type-signals/dist/type-signals.esm.js":[function(require,module,exports) {
"use strict";
...
exports.XhrResponseType = exports.XhrLoadStrategy = exports.VideoLoadStrategy = exports.ResourceType = exports.ResourceState = exports.Resource = exports.MediaElementLoadStrategy = exports.Loader = exports.ImageLoadStrategy = exports.AudioLoadStrategy = exports.AbstractLoadStrategy = void 0;

var _typeSignals = require("type-signals");
...
var AbstractLoadStrategy = function () {
  function AbstractLoadStrategy(config) {
    this.config = config;
    this.onError = new _typeSignals.Signal();
    this.onComplete = new _typeSignals.Signal();
    this.onProgress = new _typeSignals.Signal();
  }
...
var XhrResponseType;
exports.XhrResponseType = XhrResponseType;
...
})(XhrResponseType || (exports.XhrResponseType = XhrResponseType = {}));
...
var AsyncQueue = function () {
  function AsyncQueue(worker, concurrency) {
    ...
    this._started = false;
    this._tasks = [];
    this.onSaturated = new _typeSignals.Signal();
    this.onUnsaturated = new _typeSignals.Signal();
    this.onEmpty = new _typeSignals.Signal();
    this.onDrain = new _typeSignals.Signal();
    this.onError = new _typeSignals.Signal();
...
var Resource = function () {
  function Resource(name, options) {
    this.children = [];
    this.onStart = new _typeSignals.Signal();
    this.onProgress = new _typeSignals.Signal();
    this.onComplete = new _typeSignals.Signal();
    this.onAfterMiddleware = new _typeSignals.Signal();
    this.data = null;
  ...
  Resource.prototype._determineCrossOrigin = function (url, loc) {
    ...
    var parsed = (0, _parseUri.default)(Resource._tempAnchor.href, {
      strictMode: true
    });
...
var Loader = function () {
  function Loader(baseUrl, concurrency) {
    ...
    this.resources = {};
    this.onError = new _typeSignals.Signal();
    this.onLoad = new _typeSignals.Signal();
    this.onStart = new _typeSignals.Signal();
    this.onComplete = new _typeSignals.Signal();
    this.onProgress = new _typeSignals.Signal();
    this._baseUrl = '';
  ...
  Loader.prototype._prepareUrl = function (url, baseUrl) {
    ...
    this._urlResolvers.forEach(function (resolver) {
      ...
      parsed = (0, _parseUri.default)(url, {
        strictMode: true
      });
    });
...
},{"type-signals":"node_modules/type-signals/dist/type-signals.esm.js","parse-uri":"node_modules/parse-uri/index.js"}],"src/assets/bunny.png":[function(require,module,exports) {
module.exports = "/bunny.3fbd9372.png";
},{}],"src/assets/megaman.png":[function(require,module,exports) {
module.exports = "/megaman.39979638.png";
},{}],"src/assets/map.png":[function(require,module,exports) {
module.exports = "/map.fb3f118e.png";
},{}],"src/assets/fonts/visitor/visitor1.ttf":[function(require,module,exports) {
module.exports = "/visitor1.3569190f.ttf";
},{}],"src/lib/screen.ts":[function(require,module,exports) {
"use strict";
...
exports.getResolution = function (containerWidth, containerHeight, minWidth, minHeight) {
  ...
  if (containerWidth / containerHeight === minWidth / minHeight) {
    var _factor = containerWidth / minWidth;

    return {
      width: minWidth * _factor,
      height: minHeight * _factor,
      factor: _factor
    };
  }

  var factor = 1;
  var width = minWidth * factor;
  var height = minHeight * factor; // Lastly, limit scale factor to whole increments while smaller than
  // the container.
...
var bunny_png_1 = __importDefault(require("./assets/bunny.png"));

var megaman_png_1 = __importDefault(require("./assets/megaman.png"));

var map_png_1 = __importDefault(require("./assets/map.png"));

var visitor1_ttf_1 = __importDefault(require("./assets/fonts/visitor/visitor1.ttf"));

var screen_1 = require("./lib/screen");

var GAME_WIDTH = 384;
var GAME_HEIGHT = 216;
var loader = new resource_loader_1.Loader();
var canvas = document.getElementById('canvas');
var ctx = canvas.getContext('2d');
canvas.width = GAME_WIDTH;
canvas.height = GAME_HEIGHT;
ctx.imageSmoothingEnabled = false;
canvas.style.width = "".concat(GAME_WIDTH, "px");
canvas.style.height = "".concat(GAME_HEIGHT, "px");
...
var resize = function resize() {
  ...
  var _screen_1$getResoluti = screen_1.getResolution(innerWidth, innerHeight, GAME_WIDTH, GAME_HEIGHT),
      factor = _screen_1$getResoluti.factor;

  canvas.style.transform = "scale(".concat(factor, ")");
...
loader.add(bunny_png_1.default).add(megaman_png_1.default).add(map_png_1.default).add(visitor1_ttf_1.default).load( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(loader, resources) {
    var font, visitorFont, bunnyResource, playerResource, mapResource, player, TARGET_FPS, STEP, last, deltaTimeAccumulator, frame;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            frame = function _frame(hrt) {
              ...
              ctx.setTransform(exports.IDENTITY_MATRIX);
            ...
            font = new FontFace('Visitor', "url(".concat(visitor1_ttf_1.default, ")"));
            _context.next = 4;
            return font.load();

          case 4:
            visitorFont = _context.sent;
            document.fonts.add(visitorFont);
            bunnyResource = resources[bunny_png_1.default];
            playerResource = resources[megaman_png_1.default];
            mapResource = resources[map_png_1.default];
            player = {
              pos: {
...
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","resource-loader":"node_modules/resource-loader/dist/resource-loader.esm.js","./assets/bunny.png":"src/assets/bunny.png","./assets/megaman.png":"src/assets/megaman.png","./assets/map.png":"src/assets/map.png","./assets/fonts/visitor/visitor1.ttf":"src/assets/fonts/visitor/visitor1.ttf","./lib/screen":"src/lib/screen.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
